...
class Simulator:
    ...
    def single_run(self, fee_mul, leverage):
        # Data for prices
        initial_price = 1.0
        initial_fee = float(self.simulation_data[0]['fee'])

        amm = AMM(collateral=(1.0 * leverage), leverage=leverage, fee=initial_fee, oracle=initial_price)
...
if __name__ == '__main__':
    ...
    simulator.single_run(fee_mul=FEE_MUL, leverage=2)
